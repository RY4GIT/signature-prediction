...
set config_files=config_pred_hys_gg2_baddata config_pred_hys_only config_pred_gg2_only config_pred_hys_gg2_baddata_Wu config_pred_hys_only_Wu config_pred_gg2_only_Wu
