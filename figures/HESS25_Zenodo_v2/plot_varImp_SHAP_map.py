...
rf_out_dir = os.path.join(rf_dir, "output_raraki_20260729_cluster_all")
rf_out_dir_Wu = os.path.join(rf_dir, "output_raraki_20250827_cluster_all_Wu")
fig_dir = os.path.join(cloud_dir, "figs", "HESS25_Zenodo_v2", "fig_varImp")
sfig_dir = os.path.join(cloud_dir, "figs", "HESS25_Zenodo_v2", "supfig_varImp")
user_name = "raraki"
...
caravan_attrs_dir = r"E:\data\Caravan1.5\attributes"
