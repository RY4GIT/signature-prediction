...
parfor idx = 1:numGauges
    try
        ...
        switch sig_cat
            ...
            case 'calc_All_custom_shortlist'
                signatures = calc_All_custom_shortlist(Q, t, P, PET, T,...
                    'min_termination', OF_param.min_termination, ...
                    'min_duration', OF_param. min_duration, ...
                    'min_intensity_day', OF_param.min_intensity_day, ...
                    'min_intensity_day_during', OF_param.min_intensity_day_during, ...
...
%         doing vertcat
        ...
        if strcmp(sig_cat,'calc_All_custom_shortlist')
            fieldNames = {
                'BFI', 'BFI_error_str', ...
                'BaseflowRecessionK', 'BaseflowRecessionK_error_str', ...
                'AverageStorage', 'AverageStorage_error_str', ...
                'RecessionParameters_b', 'RecessionParameters_error_str', ...
                ...
                'IE_thresh_signif', 'SE_thresh_signif', ...
                'IE_thresh', 'SE_thresh', ...
                'R_Pvol_RC', 'R_Pint_RC', 'OF_error_str', ...
                'avg_IE_SE_thresh', 'avg_IE_SE_signif', 'diff_RCPint_RCPvol' ...
            };
        else
            fieldNames = {
...
if strcmp(sig_cat,'calc_All_custom') || strcmp(sig_cat,'calc_All')
